                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator
                                    ...
                                    runat="server" />
                                <br />
                                <span>因稿件发布者所有拥有的站点栏目权限为用户投稿范围，请输入拥有站点及栏目权限的管理员账号，所有会员的稿件以同一管理员身份发布投递的稿件</span><br />
                ...
                <table class="table noborder">
                    <tr>
                        <td class="center">
                            ...
                            <input type="button" class="btn" value="返 回" onclick="javascript: location.href = 'background_userNewGroup.aspx';" />
