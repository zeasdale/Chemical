<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.CMS.BackgroundPages.ConsoleLearningCentreAdd" Trace="false" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="popover popover-static">
            <h3 class="popover-title">添加学习中心</h3>
            <div class="popover-content">
                ...
                <table class="table noborder">
                    <tr>
                        <td width="80">所属分类： </td>
                        <td>
                            <asp:DropDownList ID="ddlLearningClassifyID" OnSelectedIndexChanged="ddlLearningClassifyID_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>名称：</td>
                        <td>
                            <asp:TextBox ID="tbLearningCentreName" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator"
                                ControlToValidate="tbLearningCentreName"
                    ...
                    <tr>
                        <td>地址：</td>
                        <td>
                            <asp:TextBox ID="tbLearningCentreAddress" runat="server"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                runat="server"
                                ControlToValidate="tbLearningCentreAddress"
                                ValidationExpression="[^']+"
                                ErrorMessage=" *" ForeColor="red"
                                Display="Dynamic" />
                        </td>
