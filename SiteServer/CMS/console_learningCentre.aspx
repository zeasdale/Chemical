<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.ConsoleLearningCentre" %>
    ...
    <form class="form-inline" runat="server">
      ...
      <asp:TextBox class="input-medium" ID="Keyword" runat="server" />
        ...
        <table class="table table-bordered table-hover">
            <tr class="info thead">
                <td class="center" style="width: 180px;">学习中心名称</td>
            ...
            <asp:Repeater ID="rptContents" runat="server">
                <ItemTemplate>
                    <tr>
                        <td>
                            <asp:Literal ID="ItemLearningCentreName" runat="server"></asp:Literal>
                        </td>
                        <td>
                            <asp:Literal ID="ItemLearningCentreAddress" runat="server"></asp:Literal>
                        </td>
                        <td>
                            <asp:Literal ID="ItemPhone" runat="server"></asp:Literal>
                        </td>
                        <td>
                            <asp:Literal ID="ItemLearningArea" runat="server"></asp:Literal>
                        </td>
                        <td>
                            <asp:Literal ID="ItemLearningClassify" runat="server"></asp:Literal>
                        </td>
                        <td class="center">
                        ...
                        <td class="center">
                            <input type="checkbox" name="ContentIDCollection" value='<%#DataBinder.Eval(Container.DataItem, "LearningCentreID")%>' />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
