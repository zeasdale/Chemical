<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.LearningCentreTaxis" Trace="false" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <table class="table table-noborder table-hover">
            <tr>
                <td width="120">
                    <bairong:Help HelpText="对所选学习中心排序的方向" Text="排序方向：" runat="server"></bairong:Help>
                </td>
                <td>
            ...
            <tr>
                <td width="120">
                    <bairong:Help HelpText="对所选学习中心移动的数目" Text="移动数目：" runat="server"></bairong:Help>
                </td>
                <td>
