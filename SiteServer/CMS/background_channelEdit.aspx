    ...
    <div class="popover-content">
      ...
      <table class="table noborder table-hover">
        ...
        <tr id="LinkTypeRow" runat="server">
          <td>链接类型：</td>
          <td><asp:DropDownList id="LinkType" runat="server"> </asp:DropDownList></td>
        </tr>
        <tr id="ChannelTemplateIDRow" runat="server">
          <td>栏目模版：</td>
          <td><asp:DropDownList id="ChannelTemplateID" DataTextField="TemplateName" DataValueField="TemplateID" runat="server"> </asp:DropDownList></td>
        </tr>
        <tr>
          <td>本栏目的内容模版：</td>
          <td>
