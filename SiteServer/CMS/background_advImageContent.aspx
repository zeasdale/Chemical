<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundAdvImageContent" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
            ...
            <asp:Button class="btn btn-success" ID="btnAdd" Text="添加广告" runat="server" />
            ...
            <div id="contentSearch" style="margin-top: 10px;">
                ...
                &nbsp;&nbsp;
                <!--<asp:DropDownList ID="ddlAdvImageClassify1" runat="server"></asp:DropDownList>
                <asp:DropDownList ID="ddlAdvImageClassify2" runat="server"></asp:DropDownList>-->
                时间从：
      ...
      <asp:TextBox class="input-medium" ID="tbKeyword" runat="server" />
        ...
        <table id="contents" class="table table-bordered table-hover">
            <tr class="info thead">
                ...
                <td class="center" style="width: 80px;">广告名称</td>
                <td class="center" style="width: 80px;">广告分类</td>
                <td class="center" style="width: 80px;">添加者</td>
                <td class="center" style="width: 80px;">最后编辑者</td>
                <td class="center" style="width: 80px;">广告路径</td>
