<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.CMS.Pages.MLibManage.DraftContent" %>
    ...
    <form id="myForm" enctype="multipart/form-data" runat="server">
        ...
        <div class="mcon">
            ...
            <div class="mcR">
                ...
                <div class="mc4_top">
                    <a class="mc4_a1" id="systemNotice" href="contents.aspx">已投稿件</a>
                    <a class="mc4_a1 mc4_cuta1" id="systemMsg" href="draftcontent.aspx">草稿</a>
                </div>
                <div class="main-cont">
                    <div class="tab-box">
