...
-----学习中习分类
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('siteserver_LearningClassify') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYS.INDEXES WHERE NAME = 'IX_siteserver_LearningClassify_Taxis')
CREATE CLUSTERED INDEX IX_siteserver_LearningClassify_Taxis ON siteserver_LearningClassify(Taxis)
GO

-----学习中习区域
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('siteserver_LearningArea') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYS.INDEXES WHERE NAME = 'IX_siteserver_LearningArea_Taxis')
CREATE CLUSTERED INDEX IX_siteserver_LearningArea_Taxis ON siteserver_LearningArea(Taxis)
GO

----学习中心信息表
IF NOT EXISTS(SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('siteserver_LearningCentre') AND OBJECTPROPERTY(ID,'IsTable') = 1)
...
IF NOT EXISTS(SELECT * FROM SYS.INDEXES WHERE NAME = 'IX_siteserver_LearningCentre_Taxis')
